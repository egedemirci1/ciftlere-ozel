...
if (typeof document !== 'undefined') {
  document.title = 'Ahu & Yaman - Anılar';
}
...
export default function MemoriesPage() {
  ...
  const fetchMemories = async () => {
    ...
    try {
      ...
      const { mockupMemories } = await import('@/lib/mockup-data');
      setMemories(mockupMemories);
    } catch (error) {
  ...
  const handleSubmitMemory = async () => {
    ...
    alert('Bu mockup versiyonunda yeni anı eklenemez. Sadece mevcut anıları görüntüleyebilirsiniz.');
  ...
  const handleDeleteMemory = async (memoryId: string) => {
    ...
    alert('Bu mockup versiyonunda anı silinemez. Sadece mevcut anıları görüntüleyebilirsiniz.');
  };
  ...
  const handleSubmitAddMedia = async () => {
    // Frontend-only mockup: Media ekleme yapılamaz
    alert('Bu mockup versiyonunda medya eklenemez. Sadece mevcut anıları görüntüleyebilirsiniz.');
