...
if (typeof document !== 'undefined') {
  document.title = 'Ahu & Yaman - Ayarlar';
}
...
export default function SettingsPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      // Frontend-only mockup: Export işlemi devre dışı
      await new Promise(resolve => setTimeout(resolve, 1000)); // Simulate delay
      alert('Bu mockup versiyonunda veri export edilemez. Sadece görüntüleme amaçlıdır.');
    } catch (error) {
