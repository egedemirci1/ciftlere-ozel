...
if (typeof document !== 'undefined') {
  document.title = 'Ahu & Yaman - Yıldönümleri';
}
...
export default function AnniversariesPage() {
  ...
  const fetchAnniversaries = async () => {
    try {
      ...
      const { mockupAnniversaries } = await import('@/lib/mockup-data');
      setAnniversaries(mockupAnniversaries);
    } catch (error) {
  ...
  const handleCreateAnniversary = async (e: React.FormEvent) => {
    ...
    alert('Bu mockup versiyonunda yeni yıldönümü eklenemez. Sadece mevcut yıldönümlerini görüntüleyebilirsiniz.');
