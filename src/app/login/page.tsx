...
if (typeof document !== 'undefined') {
  document.title = 'Ahu & Yaman - Giriş';
}
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Frontend-only login - import from auth.ts
      ...
      if (success) {
        ...
        if (rememberMe) {
          localStorage.setItem('ahu_yaman_remembered_username', username);
          localStorage.setItem('ahu_yaman_remember_me', 'true');
        } else {
        ...
        setError('Kullanıcı adı: test, Şifre: test');
      }
    } catch {
