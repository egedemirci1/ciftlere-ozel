...
export function DailyQuote({ className = '' }: DailyQuoteProps) {
  ...
  const quotes = [
    { text: "Aşk, iki kişinin birlikte büyümesidir.", author: "Ahu & Yaman" },
    { text: "Her anı, gelecekteki mutluluğunuzun tohumudur.", author: "Ahu & Yaman" },
    { text: "Birlikte yaşanan her gün, yeni bir maceradır.", author: "Ahu & Yaman" },
    { text: "Sevgi, en güzel anıları yaratır.", author: "Ahu & Yaman" },
    { text: "Birlikte geçirilen zaman, en değerli hazinedir.", author: "Ahu & Yaman" },
    { text: "Her fotoğraf, bir hikayenin başlangıcıdır.", author: "Ahu & Yaman" },
    { text: "Aşk, iki kalbin tek bir ritimde atmasıdır.", author: "Ahu & Yaman" },
    { text: "Birlikte gülmek, en güzel müzikdir.", author: "Ahu & Yaman" },
    { text: "Her şehir, yeni bir anı demektir.", author: "Ahu & Yaman" },
    { text: "Sevgi, en güzel yolculuğun adıdır.", author: "Ahu & Yaman" }
  ];
